 ...
 if(isset($_POST['submit']))
 {
	...
	try{
        ...
        $qryu = "UPDATE leavetrack
                 SET deandircom=:com, deandirrec=:rec, deandirid=:deandirid, deandirdate =:deandirdate
        ...
        // bind the parameters
        $stmtu->bindParam(':deandirid', $deandirid);
        $stmtu->bindParam(':com', $com);
        $stmtu->bindParam(':rec', $rec);
        $stmtu->bindParam(':deandirdate', $deandirdate);
