<?php
	...
	checkSession();
        ...
        /*************************************************************************/
    try {
        $queryleave = "SELECT pdata.staffid, staffname, leavetype, deandircom, deandirrec, appstatus
						FROM ((leavetrack
					...
					while($row=$stmtleave->fetch(PDO::FETCH_ASSOC))
		             {
		               ...
		               echo "<tr>";
		                  ...
		                  echo "<a href='hrupdate.php?id={$staffid}' class='btn btn-info m-r-1em'>View</a>";
