...
if (isset($_GET['id']))
    ...
    try {
        ...
        $qryh = "SELECT leavetype, reason, startdate, enddate, registrarrec, registrarcom
				FROM leavetrack
 ...
 if(isset($_POST['submit']))
 {
	...
	try{
        ...
        $qryu = "UPDATE leavetrack
                 SET vccom=:com, vcrec=:rec, vcid=:vcid, vcdate =:vcdate
        ...
        // bind the parameters
        $stmtu->bindParam(':vcid', $vcid);
        $stmtu->bindParam(':com', $com);
        $stmtu->bindParam(':rec', $rec);
        $stmtu->bindParam(':vcdate', $vcdate);
