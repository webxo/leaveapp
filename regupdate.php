...
if (isset($_GET['id']))
    ...
    try {
        ...
        $qryh = "SELECT leavetype, reason, startdate, enddate, hrrec, hrcom
				FROM leavetrack
 ...
 if(isset($_POST['submit']))
 {
	...
	try{
        ...
        $qryu = "UPDATE leavetrack
                 SET registrarcom=:com, registrarrec=:rec, registrarid=:registrarid, registrardate =:registrardate
        ...
        // bind the parameters
        $stmtu->bindParam(':registrarid', $registrarid);
        $stmtu->bindParam(':com', $com);
        $stmtu->bindParam(':rec', $rec);
        $stmtu->bindParam(':registrardate', $registrardate);
